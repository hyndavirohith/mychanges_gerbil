...
public class GSInKBClassifyingEvaluatorDecoratorTest
    ...
    public static Collection<Object[]> data() {
        ...
        testConfigs.add(new Object[] { new MeaningSpan[] { new NamedEntity(0, 5, "http://kb/1") },
                new MeaningSpan[] { new NamedEntity(0, 5, "http://kb/1") }, new int[] { 1 }, new int[] { 1 } });
        ...
        testConfigs.add(new Object[] { new MeaningSpan[] { new NamedEntity(10, 5, "http://kb/1") },
                new MeaningSpan[] { new NamedEntity(0, 5, "http://kb/1") }, new int[] { 1 }, new int[] { 0 } });
        // test case with empty annotator results (tp=0,fn=1,fp=0)
        testConfigs.add(new Object[] { new MeaningSpan[] { new NamedEntity(0, 5, "http://ukb/1") },
                new MeaningSpan[] {}, new int[] { 0 }, new int[] {} });
        // test case with empty gold standard (tp=0,fn=0,fp=1)
        testConfigs.add(new Object[] { new MeaningSpan[] {},
                new MeaningSpan[] { new NamedEntity(0, 5, "http://ukb/1") }, new int[] {}, new int[] { 0 } });
        // test case with single exact matching Meanings (tp=1,fn=0,fp=0)
        testConfigs.add(new Object[] { new MeaningSpan[] { new NamedEntity(0, 5, "http://ukb/1") },
                new MeaningSpan[] { new NamedEntity(0, 5, "http://ukb/1") }, new int[] { 0 }, new int[] { 0 } });
    ...
    public GSInKBClassifyingEvaluatorDecoratorTest(MeaningSpan[] goldStandard, MeaningSpan[] annotatorResponse,
            int[] expectedGSClassification, int[] expectedAnnoClassification) {
        super(expectedGSClassification, expectedAnnoClassification, MarkingClasses.GS_IN_KB);
